...
*   **Suffixes:** `-y`, `-dy`, `-in`, `-l`.
*   **Reduction:** Stripping these affixes reduces the vocabulary size significantly.
    *   *Correction:* The script `task151_morphology.py` was too timid (1.06x reduction). We need to apply these rules recursively.
